...
namespace CompareWindows {
    public partial class MainForm2 : Form {
        private TreeModle2 leftTreeModle;
        private TreeModle2 rightTreeModle;
        ...
        private void StartAsynRefeashDisplay() {
            ...
            if (!string.IsNullOrEmpty(leftPath)) {
                leftTreeModle = new TreeModle2(leftPath);
            } // end if
            if (!string.IsNullOrEmpty(rightPath)) {
                rightTreeModle = new TreeModle2(rightPath);
            } // end if
        ...
        private void AsynRefeashDispaly(Action backCall) {
            TreeModle2.CompareModle(leftTreeModle, rightTreeModle);
